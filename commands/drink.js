    ...
    if (message.member.roles.cache.has(config.roles.voted)) {
      ...
      fetch('https://www.thecocktaildb.com/api/json/v1/1/random.php')
        ...
        .then(data => {
          ...
          const recipe = `[Google](https://google.com/search?q=${encodeURI(drink.strDrink)}+drink+recipe)`

          embed.setTitle(drink.strDrink)
            .setDescription(`Enjoy your drink, comrade ${message.author} :tropical_drink:`)
